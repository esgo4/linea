...
CREATE TABLE `prensa`  (
  ...
  `rfc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `constancia_rfc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `comprobante_domicilio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `opinion_cumplimiento` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `declaracion_anual` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `redes_sociales` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `carta_protesta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fkuse`(`user_id`) USING BTREE,
  CONSTRAINT `fkuse` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of prensa
-- ----------------------------
INSERT INTO `prensa` VALUES (1, 'ESAUL GOMEZ', 74, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `prensa` VALUES (2, 'OSCAR CARRILLO', 75, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `prensa` VALUES (3, 'OSCAR CARRILLO LOPEZ', 76, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- Records of profile
-- ----------------------------
INSERT INTO `profile` VALUES (74, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `profile` VALUES (75, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `profile` VALUES (76, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `user`  (
  ...
  `nombre` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (74, 'esaul', 'esaulgomez@gmail.com', '$2y$10$8y4xjomazAcC7VuXJriblOpLe/hpgdQw9RDjRoOeu32eFg.zNsvGa', 'r7-hLmBnxza1H9YtEVkiCmqbmYls7DOU', NULL, '127.0.0.1', 0, 1654541765, NULL, 1654541765, 1654541765, 1654541788, '127.0.0.1', '', 0, 1654541765, 0, NULL, 0, NULL, 'ESAUL GOMEZ');
INSERT INTO `user` VALUES (75, 'esaul1', 'esaulgomez1@gmail.com', '$2y$10$LYg8OsRa.nHSOBn1TFFNl.a/fGRYxE7KoA6xIO4hA3UjCd1pBmiCK', 'Ng0-JRJBNP3ERpFWo6GgT7ZARN8tFl_N', NULL, '127.0.0.1', 0, 1654544567, NULL, 1654544568, 1654544568, 1654544592, '127.0.0.1', '', 0, 1654544568, 0, NULL, 0, NULL, 'OSCAR CARRILLO');
INSERT INTO `user` VALUES (76, 'esaul3', 'esaulgomez4@gmail.com', '$2y$10$WRvxfpTb7H6CdB5qUwvkwO1Moibp4.nVjgs.FzKVUukPOOix13vjO', 'pyLl0V4UYhS919iBQNij8qwqg93Y2pVX', NULL, '127.0.0.1', 0, 1654549661, NULL, 1654549661, 1654549661, 1654549680, '127.0.0.1', '', 0, 1654549661, 0, NULL, 0, NULL, 'OSCAR CARRILLO LOPEZ');
