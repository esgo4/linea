...
/**
 * ResidenciaBuscar represents the model behind the search form of `frontend\models\Residencia`.
 */
class ResidenciaBuscar extends Residencia
{
    /**
     * {@inheritdoc}
     */
