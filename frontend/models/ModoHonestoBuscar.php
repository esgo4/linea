...
/**
 * ModoHonestoBuscar represents the model behind the search form of `frontend\models\ModoHonesto`.
 */
class ModoHonestoBuscar extends ModoHonesto
{
    /**
     * {@inheritdoc}
     */
